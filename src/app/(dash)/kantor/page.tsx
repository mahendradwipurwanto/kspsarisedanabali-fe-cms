...
const FIELDS: TableField<Branch>[] = [
  ...
  { key: 'phone', label: 'Telepon', type: 'tel', width: 150, hint: 'Angka saja. Contoh: 03665438200' },
  { key: 'whatsapp', label: 'WhatsApp', type: 'tel', width: 150, hint: 'Angka saja. Contoh: 081337168194' },
