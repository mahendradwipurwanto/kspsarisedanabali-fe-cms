...
export const NAV: NavItem[] = [
  ...
  { label: 'Lowongan', href: '/lowongan', icon: Briefcase, group: 'Konten', perms: ['jobs:read'] },
  { label: 'Lamaran Kerja', href: '/lamaran', icon: FileUser, group: 'Konten', perms: ['jobs:applications'] },
